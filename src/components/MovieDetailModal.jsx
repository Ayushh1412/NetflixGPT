  ...
  return (
    <AnimatePresence>
      {modalOpen && selectedMovie && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black bg-opacity-80 p-4 overflow-y-auto">
          ...
          <motion.div
            ...
            className="bg-zinc-900 rounded-lg overflow-hidden max-w-4xl w-full max-h-[90vh] flex flex-col md:flex-row relative shadow-2xl border border-zinc-700 z-10"
          ...
          >
            ...
            <button
              ...
              className="absolute top-2 right-2 md:top-4 md:right-4 text-white text-3xl hover:text-red-600 z-[110] bg-black bg-opacity-60 rounded-full w-10 h-10 flex items-center justify-center transition-colors shadow-lg"
            >
              &times;
            </button>
